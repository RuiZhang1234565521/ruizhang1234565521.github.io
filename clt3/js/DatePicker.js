...
Calendar.prototype.style = function(){
	...
	strStyle += ".calendar {font-size:24px; margin:0;padding:0px;border:1px solid #397EAE;background-color:#DBE7F2;}";
	...
	strStyle += ".calendar li a{ text-decoration:none; font-family:Tahoma; font-size:24px; color:#333}";
	...
	strStyle += ".lastMonthDate, .nextMonthDate {color:#bbb;font-size:24px}";
	strStyle += ".selectThisYear, .selectThisMonth{text-decoration:none; margin:0px; color:#000; font-weight:bold}";
	strStyle += ".calendar .LastMonth, .calendar .NextMonth{text-decoration:none; color:#000; font-size:24px; font-weight:bold; line-height:16px;}";
	strStyle += ".calendarTitle{background:#EDF3F9;text-align:center;height:30px;line-height:30px;clear:both;width:100%;}";
	strStyle += ".calendarTitle .mark{text-decoration:none;color:#000;font-family:Tahoma;font-size:24px;font-weight:normal;}";
	strStyle += ".today{ background-color:#ffffaa;border:1px solid #f60;padding:0 1px;}";
	strStyle += ".today a { color:#f30; }";
	strStyle += ".calendarBottom {text-align:center;height:30px;line-height:30px;clear:both;width:100%;border-top:1px solid #ddd;}";
	strStyle += ".calendarBottom li{float:left;height:30px;line-height:30px;font-weight:bold;text-align:center;}";
	strStyle += "</style>";
	return strStyle;
}
...
function Calendar(inputObj, dateFormatStyle, beginDate, endDate, lang, type) {   
  this.beginDate = "2016-09-01".toDate();
  this.endDate = "2030-12-31".toDate();
...
Calendar.prototype.draw = function() {   
  ...
  var lis = "<div id='calendar' class='calendar' style='width:200px;'>";
